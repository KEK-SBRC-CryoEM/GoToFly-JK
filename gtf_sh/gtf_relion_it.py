...
"""
Date: 2021/10/03
Authors: Toshio Moriya (KEK, Japan)
Note:
Based on the orignal relion_it.py, the script is modified to fit needs of the Cryo-EM facility at KEK, Japan.
This development is a part of the "GoToFly(JK)" project.
...
RelionItOptions = {
    ...
    'prep__ctffind__fn_ctffind_exe' : '/gpfs/data/EM/software/ctffind-4.1.13/bin/ctffind',  # <- 'prep__ctffind__fn_ctffind_exe' : '/public/EM/ctffind/ctffind.exe',
    ...
    'do_auto_boxsize' : False, # <- 'do_auto_boxsize' : True,
    ...
    'proc__autopick__fn_topaz_exec' : 'topaz', # <- 'proc__autopick__fn_topaz_exec' : '/public/EM/RELION/topaz',
    ...
    'proc__autopick__use_gpu' : True, # <- 'proc__autopick__use_gpu' : False,
    ...
    'proc__extract__do_fom_threshold' : True, # <- 'proc__extract__do_fom_threshold' : False,
    # Minimum FOM for topaz extraction
    'proc__extract__minimum_pick_fom' : 0,

    ### Perform LoG picking instead of topaz 
    'proc__do_log' : False, # <- 'proc__do_log' : True,
    ...
    'proc__class2d__particle_diameter' : 214, # <- 'proc__class2d__particle_diameter' : 200,
    ...
    # Symmetry
    'proc__inimodel3d__sym_name' : 'C1', # <- 'proc__inimodel3d__sym_name' : 'D2',
    'proc__refine3d__sym_name' : 'C1', # <- 'proc__refine3d__sym_name' : 'D2',
    # Diameter of the mask used for inimodel3d and refine3d (in Angstrom)
    'proc__inimodel3d__particle_diameter' : 214,
    'proc__refine3d__particle_diameter' : 214,
