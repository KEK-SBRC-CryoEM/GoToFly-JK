...
class RelionItOptions(object):
    ...
    motioncor_exe = '/gpfs/data/EM/software/MotionCor2/MotionCor2_1.4.0_Cuda101'
    ...
    ctffind_maxres = 4
    ctffind_minres = 30
    ctffind_defocus_max = 30000
    ctffind_defocus_min = 5000
    ctffind_defocus_step = 100
    # For Gctf: ignore parameters on the 'Searches' tab?
    ctffind_do_ignore_search_params = False
    ...
    gctf_exe = '/gpfs/data/EM/software/GCTF_Gautomatch_Cu10.1/GCTF_v1.18_sm30-75_cu10.1'
    ...
    ctffind4_exe = '/gpfs/data/EM/software/ctffind-4.1.14/ctffind'
